    ...
    >
        ...
        <div class="flex grow justify-end gap-3 me-4">
                ...
                >
                    <li>
                        <a href="#experiences">
                            ...
                            <span>{{ $t("header.nav.experiences") }}</span></a
                        >
                    </li>
                    <li class="border-t border-solid">
                        <a href="#projects">
                            <hammer-wrench-icon class="mb-1" />
                            <span>{{ $t("header.nav.projects") }}</span></a
                        >
                    </li>
                    <li class="border-t border-solid">
                        <a href="#footer">
                            <account-tie-icon class="mb-1" />
                            <span>{{ $t("header.nav.contact") }}</span></a
                        >
                    </li>
                </ul>
            </div>
            ...
            >
                ...
                <li class="flex items-center">
                    <a href="#footer" class="flex items-center gap-1">
...
import { theme, toggleThemeMode, DARK } from "@/utils/themeUtils";
